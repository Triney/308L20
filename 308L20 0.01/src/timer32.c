...
extern volatile uint8_t 	CheckFlag_1;
//extern volatile uint8_t		BlockOption;
uint16_t   DALI_Data ; 
volatile uint8_t	TimeCir_1st=0;
volatile uint8_t 	TimeCir_2nd=0;
volatile uint8_t 	TimeCir_3rd=0;
